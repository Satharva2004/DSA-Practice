...
[![LeetCode](https://img.shields.io/badge/LeetCode-count--complete--tree--nodes-FFA116?style=flat-square&logo=leetcode&logoColor=white)](https://leetcode.com/problems/count-complete-tree-nodes)
[![Easy](https://img.shields.io/badge/Easy-2ea44f?style=flat-square)](https://leetcode.com/problems/count-complete-tree-nodes)
...
|---|------|-------|
| **Complexity** | `O(n)` | `O(h)` |
| **Explanation** | visiting each node once in the binary tree | recursion stack depth at most the height of the tree |
...
<div align="center">
<sub>Synced by <strong>LitCode</strong> on June 25, 2026</sub>
</div>
