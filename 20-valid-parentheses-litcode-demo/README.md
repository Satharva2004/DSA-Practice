...
| **`O(n)`**<br>iterating over the input string once<br><sub>Confidence: High</sub> | **`O(n)`**<br>using a stack to store characters, potentially storing all characters in the input string<br><sub>Confidence: High</sub> |
