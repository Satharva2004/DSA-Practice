...
![Runtime Beats](https://img.shields.io/badge/beats-96.01%25-22c55e?style=flat-square)
![Memory](https://img.shields.io/badge/16.4%20MB-2563eb?style=flat-square)
![Memory Beats](https://img.shields.io/badge/beats-84.33%25-22c55e?style=flat-square)
...
| **Your code** | The submitted code uses iterative simulation with O(n) time and O(n) space. |
...
| **`O(n)`**<br>The submitted code appears to scan the input once.<br><sub>Confidence: Medium</sub> | **`O(n)`**<br>The submitted code builds an output or helper container whose size can grow with the input.<br><sub>Confidence: Medium</sub> |
