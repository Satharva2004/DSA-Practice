<h2><a href="https://leetcode.com/problems/minimum-absolute-difference-in-bst">Minimum Absolute Difference in BST</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><div align="center">

# Minimum Absolute Difference in BST

[![Difficulty](https://img.shields.io/badge/Easy-2ea44f?style=flat-square)](https://leetcode.com/problems/minimum-absolute-difference-in-bst)
...
![Memory](https://img.shields.io/badge/46.8%20MB-2563eb?style=flat-square)
![Memory Beats](https://img.shields.io/badge/beats-50.16%25-22c55e?style=flat-square)
...
| --- | --- | --- | --- | --- |
| [Minimum Absolute Difference in BST](https://leetcode.com/problems/minimum-absolute-difference-in-bst) | Easy | Java | 0 ms | 46.8 MB |
...
| **`O(n)`**<br>visiting each node in the binary tree once during inorder traversal<br><sub>Confidence: Medium</sub> | **`O(n)`**<br>recursion stack can grow up to the height of the tree, which is n in the worst case<br><sub>Confidence: Medium</sub> |
