<h2><a href="https://leetcode.com/problems/kth-smallest-element-in-a-bst">Kth Smallest Element in a BST</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><div align="center">

# Kth Smallest Element in a BST

[![Difficulty](https://img.shields.io/badge/Medium-f59e0b?style=flat-square)](https://leetcode.com/problems/kth-smallest-element-in-a-bst)
...
![Memory](https://img.shields.io/badge/46.7%20MB-2563eb?style=flat-square)
![Memory Beats](https://img.shields.io/badge/beats-68.13%25-22c55e?style=flat-square)
...
| --- | --- | --- | --- | --- |
| [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst) | Medium | Java | 0 ms | 46.7 MB |
...
| **`O(n)`**<br>traversal of binary tree once<br><sub>Confidence: Medium</sub> | **`O(h)`**<br>space used by recursion stack in worst case is tree height<br><sub>Confidence: Medium</sub> |
