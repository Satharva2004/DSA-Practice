...
[![LeetCode](https://img.shields.io/badge/LeetCode-validate--binary--search--tree-FFA116?style=flat-square&logo=leetcode&logoColor=white)](https://leetcode.com/problems/validate-binary-search-tree)
[![Medium](https://img.shields.io/badge/Medium-f59e0b?style=flat-square)](https://leetcode.com/problems/validate-binary-search-tree)
...
| 🧠 Memory | **44.8 MB** | Beats **95.64%** 🏆 Top 5% |
...
|---|------|-------|
| **Complexity** | `O(n)` | `O(h)` |
| **Explanation** | each node in the binary tree is visited once | recursion stack can grow up to the height of the tree |
