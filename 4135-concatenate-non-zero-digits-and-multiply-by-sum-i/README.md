...
|--------|--------|-----------|
| ⏱️ Runtime | **3 ms** | Beats **17.79%** |
| 🧠 Memory | **42.5 MB** | Beats **67.71%** ✅ Good |
...
| **Explanation** | single loop through digits of input number | StringBuilder and string to store digits of input number |
