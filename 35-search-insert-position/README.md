...
[![LeetCode](https://img.shields.io/badge/LeetCode-search--insert--position-FFA116?style=flat-square&logo=leetcode&logoColor=white)](https://leetcode.com/problems/search-insert-position)
[![Easy](https://img.shields.io/badge/Easy-2ea44f?style=flat-square)](https://leetcode.com/problems/search-insert-position)
...
| 🧠 Memory | **44.6 MB** | Beats **82.62%** ✅ Great |
...
| **Explanation** | binary search with halved search space in each iteration | only a constant amount of space is used |
