...
![Runtime Beats](https://img.shields.io/badge/beats-99.19%25-22c55e?style=flat-square)
![Memory](https://img.shields.io/badge/44.1%20MB-2563eb?style=flat-square)
![Memory Beats](https://img.shields.io/badge/beats-83.86%25-22c55e?style=flat-square)
...
| --- | --- | --- | --- | --- |
| [Valid Palindrome](https://leetcode.com/problems/valid-palindrome) | Easy | Java | 2 ms | 44.1 MB |

## Performance

| Metric | Your result | Standing |
| --- | --- | --- |
| Runtime | **2 ms** | Beats **99.19%** |
| Memory | **44.1 MB** | Beats **83.86%** |
...
| **`O(n)`**<br>single loop through the input string<br><sub>Confidence: High</sub> | **`O(1)`**<br>constant space used for indices and no extra data structures<br><sub>Confidence: High</sub> |
