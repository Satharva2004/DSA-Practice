...
| **`O(n)`**<br>single loop over the array A<br><sub>Confidence: High</sub> | **`O(1)`**<br>constant space used for variables min, max and loop counter<br><sub>Confidence: High</sub> |
