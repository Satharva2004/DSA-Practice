...
![Runtime Beats](https://img.shields.io/badge/beats-98.42%25-22c55e?style=flat-square)
![Memory](https://img.shields.io/badge/43.1%20MB-2563eb?style=flat-square)
![Memory Beats](https://img.shields.io/badge/beats-91.20%25-22c55e?style=flat-square)
...
| --- | --- | --- |
| Runtime | **2 ms** | Beats **98.42%** |
| Memory | **43.1 MB** | Beats **91.20%** |

## Approach

| View | Notes |
| --- | --- |
| **Code uses** | Hash map / set lookup |
| **Recommended pattern** | Submitted pattern is competitive |
| **Your code** | The submitted code uses hash map / set lookup with O(n) time and O(n) space. |
...
| **`O(n)`**<br>The submitted code appears to scan the input once.<br><sub>Confidence: Medium</sub> | **`O(n)`**<br>A hash-based structure can grow with the input.<br><sub>Confidence: Medium</sub> |
